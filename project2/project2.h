 ...
 *
 * - you do NOT need to submit project2.h, but you DO need to submit WAVLTree.h
 *   make sure you do not modify any of the public WAVLTree/bin packing function declarations, as during testing
 ...
 *
 *
 * explanations for WAVLTree public member functions
 ...
 * insert(): insert item with parameter key, value into tree
 * find(): return the value of item with parameter key
 * getSize(): return the number of non-external nodes in the tree 
 * getHeight(): return the height of the tree (including external nodes)
 * getRank(): return the rank of the item with parameter key
 *
